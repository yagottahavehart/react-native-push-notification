...
NotificationsComponent.prototype.requestPermissions = function(token) {
  RNPushNotification.requestPermissions(token);
};
...
NotificationsComponent.prototype.clearNotificationStack = function (adAccountId) {
  RNPushNotification.clearNotificationStack(adAccountId);
}
